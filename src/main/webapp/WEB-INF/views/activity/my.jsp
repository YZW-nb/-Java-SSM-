...
<%--
<%--                                <!-- 详情链接 -->--%>
                                <a href="${pageContext.request.contextPath}/activity/detail?title=${activity.title}"
                                ...
                                <c:choose>
                                    <c:when test="${activity.status == 1}">
                                        <a href="${pageContext.request.contextPath}/activitysignup/signup?title=${activity.title}"
