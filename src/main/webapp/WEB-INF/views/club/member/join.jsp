...
<div class="flex h-screen overflow-hidden">
    ...
    <div class="flex-1 flex flex-col overflow-hidden">
        ...
        <main class="flex-1 overflow-y-auto p-6 bg-gray-50">
            <div class="mb-6">
                <h2 class="text-[clamp(1.5rem,3vw,2rem)] font-bold text-gray-800">加入社团</h2>
                <p class="text-gray-600">确认加入社团申请</p>
            </div>
            ...
            <div class="bg-white rounded-xl p-6 card-shadow max-w-2xl mx-auto">
                ...
                <div class="mb-6">
                    <h3 class="text-xl font-bold text-gray-800 mb-4">确认加入社团</h3>
                    <p class="text-gray-600">您确定要加入该社团吗？加入后您将获得社团的相关权限和通知。</p>
                </div>

                <div class="flex justify-end space-x-4">
                    <a href="${pageContext.request.contextPath}/club/list" class="px-6 py-2 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 transition-colors">
                        返回
                    </a>
                    <form action="${pageContext.request.contextPath}/club/member/join/${clubId}" method="post">
