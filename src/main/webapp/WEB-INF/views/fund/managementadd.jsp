    ...
    <div class="flex-1 flex flex-col overflow-hidden">
        ...
        <main class="flex-1 overflow-y-auto p-6 bg-gray-50">
            ...
            <div class="bg-white rounded-xl p-6 card-shadow mb-8">
                <form id="fundForm" action="${pageContext.request.contextPath}/fund/fund/add" method="post">
                    ...
                    <div class="mt-8 flex justify-end space-x-3">
                        <a href="${pageContext.request.contextPath}/fund/management" class="px-4 py-2 border border-gray-300 rounded-lg text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors">
                            返回列表
                        </a>
